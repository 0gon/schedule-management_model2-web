	...
	<div class="w3-container">
		...
		<div class="calendarForm w3-center  w3-container" id="modal">
			<form id="userinput_u" method="post"
				...
				<input type="hidden" name="id" value="o${overtimeVO.id }"> <input
					type="hidden" name="memberId" value="${userVO.id }"> 
				<input
					type="hidden" name="createDate" value="${overtimeVO.createDate }">
				...
				<ul class="w3-ul w3-light-grey">
					...
					<li>
						<button class="w3-button w3-black" id="commitbtn"
							onclick="checkValue_u_o()">등록</button>
						<button id="cancelbtn"
